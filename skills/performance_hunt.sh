...
JSON_PAYLOAD=$(jq -n \
	--arg model "$MODEL" \
	--arg system "You are the Performance Hunter. Find N+1 queries, memory leaks, inefficient algorithms, and resource waste. Focus on issues that matter at scale." \
